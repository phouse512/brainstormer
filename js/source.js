...
function displayRandomOutput(){
	var output = '<h4 class="randomOutput">Who: ' + currentWho + '</h4><h4 class="randomOutput">What: ' + currentWhat + '</h4><h4 class="randomOutput">Function: ' + currentFunction +'</h4>';
	$("#output").html(output);
}
